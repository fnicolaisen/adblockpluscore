...
class FilterStorage
{
  ...
  *subscriptions(filterText = null)
   ...
   * @param {?Array.<module:filterClasses.Filter>} [filters] The filters to be
   *   reset. If not specified, all filters will be reset.
   */
  resetHitCounts(filters)
  {
    ...
    {
      for (let text of filterState._map.keys())
